<h2><i class="fa fa-cog"></i> แก้ไขข้อมูลประเภทการชำระ</h2>
...
<form id="fmPaytyp">
    <table class="paytyp-table">
        <tr>
            ...
            <td><input type="text" id="<?php echo $menucod ?>paycode" value="<?php echo $paytyp->paycode; ?>"></td>
        </tr>
        <tr>
            <td>คำอธิบาย</td>
            <td><input type="text" id="<?php echo $menucod ?>paydesc" value="<?php echo $paytyp->paydesc; ?>"></td>
        </tr>
        <tr>
            <td>รหัสบัญชี</td>
            <td><input type="text" id="<?php echo $menucod ?>accmstcod" value="<?php echo $paytyp->accmstcod; ?>"></td>
        </tr>
        <tr>
            <td>อ้างอิง</td>
            <td>
                <input type="hidden" id="<?php echo $menucod ?>v-ptype" value="<?php echo $paytyp->ptype; ?>">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#"+menucod+"paycode").jqxInput({ height: 23, width: 121, theme: theme, minLength: 1, maxLength: 10, disabled: true });
        ...
        //อ้างอิง
        if ($("#"+menucod+"v-ptype").val() == 'C') {
            $("#"+menucod+"ptype1").jqxRadioButton({ checked: true });
        } else if ($("#"+menucod+"v-ptype").val() == 'H') {
            $("#"+menucod+"ptype2").jqxRadioButton({ checked: true });
        } else {
            $("#"+menucod+"ptype3").jqxRadioButton({ checked: true });
        }
