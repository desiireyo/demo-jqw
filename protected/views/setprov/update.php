<h2><i class="fa fa-cog"></i> แก้ไขข้อมูลรหัสจังหวัด</h2>
...
<form id="fmsetprov">
    <table class="setprov-table">
        <tr>
            <td>รหัสจังหวัด</td>
            <td><input type="text" id="<?php echo $menucod ?>provcode" value="<?php echo $setprov->provcode; ?>"></td>
        </tr>
        <tr>
            <td>คำอธิบาย</td>
            <td><input type="text" id="<?php echo $menucod ?>provdesc" value="<?php echo $setprov->provdesc; ?>"></td>
        </tr>
    </table>
</form>
<br />
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#"+menucod+"provcode").jqxInput({ height: 23, width: 121, theme: theme, minLength: 1, maxLength: 10, disabled: true });
