...
<body>
	<htmlpageheader name="hader1" style="display:none">
		<h3 class="pagetitle">กำหนดข้อมูลเกรดลูกค้า</h3>
		<div class="printdate">
	...
	<div class="content">
	    <?php
	        $sql = "select * from setgrade order by grdcode ";
	        $command = Yii::app()->db->createCommand($sql);
	        $dataReader = $command->query();
	        $i = 0;
	        $dataReader->bindColumn(2, $grdcode);
	        $dataReader->bindColumn(3, $grddesc);
	        while ($dataReader->read() !== false) {
	        	echo "<p>".$grdcode."  :  ".$grddesc."</p>";
	        }
	    ?>
	</div>
</body>