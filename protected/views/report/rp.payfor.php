...
<body>
	<htmlpageheader name="hader1" style="display:none">
		<h3 class="pagetitle">กำหนดข้อมูลรหัสการชำระ</h3>
		<div class="printdate">
	...
	<div class="content">
	    <?php
	        $sql = "select * from payfor order by forcode ";
	        $command = Yii::app()->db->createCommand($sql);
	        $dataReader = $command->query();
	        $i = 0;
	        $dataReader->bindColumn(2, $forcode);
	        $dataReader->bindColumn(3, $fordesc);
	        while ($dataReader->read() !== false) {
	        	echo "<p>".$forcode."  :  ".$fordesc."</p>";
	        }
	    ?>
	</div>
</body>