...
<body>
	<htmlpageheader name="hader1" style="display:none">
		<h3 class="pagetitle">กำหนดข้อมูลสถานะสัญญา</h3>
		<div class="printdate">
	...
	<div class="content">
	    <?php
	        $sql = "select * from typecont order by typecont ";
	        $command = Yii::app()->db->createCommand($sql);
	        $dataReader = $command->query();
	        $i = 0;
	        $dataReader->bindColumn(2, $typecode);
	        $dataReader->bindColumn(3, $typedecs);
	        while ($dataReader->read() !== false) {
	        	echo "<p>".$typecode."  :  ".$typedecs."</p>";
	        }
	    ?>
	</div>
</body>