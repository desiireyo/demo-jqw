...
<body>
	<htmlpageheader name="hader1" style="display:none">
		<h3 class="pagetitle">กำหนดข้อมูลอำเภอ</h3>
		<div class="printdate">
	...
	<div class="content">
	    <?php
	        $sql = "select * from setaump ";
	        $command = Yii::app()->db->createCommand($sql);
	        $dataReader = $command->query();
	        $i = 0;
	        $dataReader->bindColumn(2, $aumpcode);
	        $dataReader->bindColumn(3, $aumpdesc);
	        while ($dataReader->read() !== false) {
	        	echo "<p>".$aumpcode."  :  ".$aumpdesc."</p>";
	        }
	    ?>
	</div>
</body>